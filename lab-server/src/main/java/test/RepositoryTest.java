...
import com.dar.server.data.dao.SpaceMarineDao;
...
public class RepositoryTest {
    ...
    public void testSpaceMarineRepo(){
        ...
        SpaceMarineEntity spm = new SpaceMarineEntity("name", new CoordinatesEntity(1L, 33f), 23, true, 33f, Color.COMBI_PLASMA_GUN, new ChapterEntity("", ""));
